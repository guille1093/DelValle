...
<div class="relative overflow-x-auto shadow-md">
    <div class="flex items-center justify-between py-4 bg-white dark:bg-gray-800">
        <div>
            <button id="dropdownActionButton" data-dropdown-toggle="dropdownAction" class="inline-flex items-center text-gray-800 bg-green-300 border border-gray-300 focus:outline-none hover:bg-green-200 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
               <i class="bx bx-plus-circle m-2"></i>
                Nuevo cliente
            </button>
        </div>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" id="clientesTabla">
        ...
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                <div class="pl-3">
                    <div class="text-base font-semibold"><a href="/clientes/{cliente.id}">{cliente.apellido + ' ' + cliente.nombre} </a></div>
                    <div class="font-normal text-gray-500"><a href="/clientes/{cliente.id}">{cliente.email}</a></div>
                </div>
            </th>
            <td class="px-6 py-4">
                <a href="/clientes/{cliente.id}">{cliente.dni}</a>
            </td>
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <a href="/clientes/{cliente.id}">{cliente.nacionalidad}</a>
                </div>
            </td>
            <td class="px-6 py-4">
                <a href="/clientes/{cliente.id}">{cliente.telefono}</a>
            </td>
            <td class="px-6 py-4">
                <a href="/clientes/{cliente.id}">{cliente.fechanacimiento}</a>
            </td>
            <td>
                <a class="text-blue-500 font-bold m-3 bx bx-edit" href="/clientes/{cliente.id}/editar"> </a>
                <a class="text-red-500 font-bold m-3  bx bx-trash" href="/clientes/{cliente.id}"> </a>
            </td>
<!--            <td class="px-6 py-4">-->
...
<!--            </td>-->
<!--            <td>-->
<!--                <button type="button" class="font-medium text-red-600 dark:text-red-500 hover:underline" on:click={() => deleteCliente(cliente.id)}>Eliminar</button>-->
<!--            </td>-->
