...
const clienteModelo = z.object({
  dni: z.string({ required_error: 'EL DNI ES OBLIGATORIO' })
    .regex(/^[1-9]\d{7}$/, { message: 'EL DNI DEBE TENER 8 DIGITOS' })
    .min(8, { message: 'EL DNI DEBE TENER 8 DIGITOS' })
    .max(8, { message: 'EL DNI DEBE TENER 8 DIGITOS' }),
  ...
  telefono: z.string({ required_error: 'EL TELEFONO ES OBLIGATORIO' })
    .regex(/^[0-9]{10}$/, { message: 'EL TELEFONO DEBE TENER 10 DIGITOS' })
    .min(10, { message: 'EL TELEFONO DEBE TENER 10 DIGITOS' })
    .max(10, { message: 'EL TELEFONO DEBE TENER 10 DIGITOS' }),
